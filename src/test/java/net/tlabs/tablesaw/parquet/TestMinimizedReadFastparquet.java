...
class TestMinimizedReadFastparquet extends AbstractTableParameterizedTest {
	...
	private static Stream<Arguments> columnValueParameters() {
		return Stream.of(Arguments.of(0, 0, true, "boolean"), Arguments.of(0, 1, false, "boolean"),
				...
				Arguments.of(5, 0, 0, "integer"), Arguments.of(5, 1, 65000, "integer"),
				Arguments.of(6, 0, 0, "integer"), Arguments.of(6, 1, -65000, "integer"), Arguments.of(7, 0, 0L, "long"),
				...
				Arguments.of(9, 1, 1.0f, "float"), Arguments.of(10, 0, 0.0d, "double"),
