...
class TestDefaultReadPyArrow extends AbstractTableParameterizedTest {
  ...
  private static Stream<Arguments> columnTypeParameters() {
    return Stream.of(
        ...
        Arguments.of(2, ColumnType.INTEGER, "int8"),
        Arguments.of(3, ColumnType.INTEGER, "uint16"),
  ...
  private static Stream<Arguments> columnValueParameters() {
    return Stream.of(
        ...
        Arguments.of(2, 0, -127, "integer"),
        Arguments.of(2, 1, 1, "integer"),
        Arguments.of(3, 0, 0, "integer"),
        Arguments.of(3, 1, 32767, "integer"),
