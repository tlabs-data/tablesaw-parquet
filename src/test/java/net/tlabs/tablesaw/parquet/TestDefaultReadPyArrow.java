...
class TestDefaultReadPyArrow extends AbstractTableParameterizedTest {
	...
	private static Stream<Arguments> columnTypeParameters() {
		return Stream.of(Arguments.of(0, ColumnType.BOOLEAN, "boolean"), Arguments.of(1, ColumnType.INTEGER, "uint8"),
				...
				Arguments.of(8, ColumnType.LONG, "int64"), Arguments.of(9, ColumnType.DOUBLE, "float32"),
	...
	private static Stream<Arguments> columnValueParameters() {
		return Stream.of(Arguments.of(0, 0, true, "boolean"), Arguments.of(0, 1, false, "boolean"),
				Arguments.of(1, 0, 0, "integer"), Arguments.of(1, 1, 127, "integer"),
				Arguments.of(2, 0, -127, "integer"), Arguments.of(2, 1, 1, "integer"), Arguments.of(3, 0, 0, "integer"),
				Arguments.of(3, 1, 32767, "integer"), Arguments.of(4, 0, 0, "integer"),
				Arguments.of(4, 1, -32767, "integer"), Arguments.of(5, 0, 0, "integer"),
				Arguments.of(5, 1, 65000, "integer"), Arguments.of(6, 0, 0, "integer"),
				Arguments.of(6, 1, -65000, "integer"), Arguments.of(7, 0, 0L, "long"),
				Arguments.of(7, 1, 1_000_000_000L, "long"), Arguments.of(8, 0, 0L, "long"),
				Arguments.of(8, 1, -1_000_000_000L, "long"), Arguments.of(9, 0, null, "double"),
				Arguments.of(9, 1, 1.0d, "double"), Arguments.of(10, 0, 0.0d, "double"),
