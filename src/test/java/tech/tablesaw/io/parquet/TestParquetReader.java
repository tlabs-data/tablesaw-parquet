...
class TestParquetReader {
  ...
  private Table validateAllTypesDefault(
    ...
    assertTrue(
        table.column(0).type() == ColumnType.INTEGER, sourceName + "[" + "id" + "] wrong type");
    assertTrue(
        table.column(1).type() == ColumnType.BOOLEAN,
        sourceName + "[" + "bool_col" + "] wrong type");
    assertTrue(
        table.column(2).type() == ColumnType.INTEGER,
        sourceName + "[" + "tinyint_col" + "] wrong type");
    assertTrue(
        table.column(3).type() == ColumnType.INTEGER,
        sourceName + "[" + "smallint_col" + "] wrong type");
    assertTrue(
        table.column(4).type() == ColumnType.INTEGER,
        sourceName + "[" + "int_col" + "] wrong type");
    assertTrue(
        table.column(5).type() == ColumnType.LONG,
        sourceName + "[" + "bigint_col" + "] wrong type");
    assertTrue(
        table.column(6).type() == ColumnType.FLOAT,
        sourceName + "[" + "float_col" + "] wrong type");
    assertTrue(
        table.column(7).type() == ColumnType.DOUBLE,
        sourceName + "[" + "double_col" + "] wrong type");
    assertTrue(
        table.column(8).type() == ColumnType.STRING,
        sourceName + "[" + "date_string_col" + "] wrong type");
    assertTrue(
        table.column(9).type() == ColumnType.STRING,
        sourceName + "[" + "string_col" + "] wrong type");
    assertTrue(
        table.column(10).type() == ColumnType.STRING,
  ...
  void testInt96AsTimestamp() throws IOException {
    ...
    assertTrue(
        table.column(10).type() == ColumnType.INSTANT,
  ...
  void testBinaryUTF8() throws IOException {
    ...
    assertTrue(
        table.column(0).type() == ColumnType.STRING, APACHE_BINARY + "[" + "foo" + "] wrong type");
    assertEquals(
  ...
  void testDataPageV2() throws IOException {
    ...
    assertTrue(
        table.column(0).type() == ColumnType.STRING,
        APACHE_DATAPAGEV2 + "[" + "a" + "] wrong type");
    assertEquals("abc", table.getString(0, 0), APACHE_DATAPAGEV2 + "[" + "a" + ",0] wrong value");
    assertTrue(
        table.column(1).type() == ColumnType.INTEGER,
        APACHE_DATAPAGEV2 + "[" + "b" + "] wrong type");
    assertTrue(
        table.column(2).type() == ColumnType.DOUBLE,
        APACHE_DATAPAGEV2 + "[" + "c" + "] wrong type");
    assertTrue(
        table.column(3).type() == ColumnType.BOOLEAN,
        APACHE_DATAPAGEV2 + "[" + "d" + "] wrong type");
    assertTrue(
        table.column(4).type() == ColumnType.TEXT, APACHE_DATAPAGEV2 + "[" + "e" + "] wrong type");
  }
  ...
  void testDictPageOffset0() throws IOException {
    ...
    assertTrue(
        table.column(0).type() == ColumnType.INTEGER,
  ...
  void testInt32Decimal() throws IOException {
    ...
    assertTrue(
        table.column(0).type() == ColumnType.INTEGER,
        APACHE_INT32_DECIMAL + "[" + "l_partkey" + "] wrong type");
    assertEquals(
        100,
        table.intColumn(0).getInt(0),
        APACHE_INT32_DECIMAL + "[" + "l_partkey" + ",0] wrong value");
    assertEquals(
        2400,
  ...
  void testInt64Decimal() throws IOException {
    ...
    assertEquals(
        table.column(0).type(),
        ColumnType.LONG,
        APACHE_INT64_DECIMAL + "[" + "l_partkey" + "] wrong type");
    assertEquals(
        100l,
        table.longColumn(0).getLong(0),
        APACHE_INT64_DECIMAL + "[" + "l_partkey" + ",0] wrong value");
    assertEquals(
        2400l,
  ...
  void testFixedLengthDecimal() throws IOException {
    ...
    assertEquals(
        table.column(0).type(),
        ColumnType.DOUBLE,
        APACHE_FIXED_LENGTH_DECIMAL + "[" + "l_partkey" + "] wrong type");
    assertEquals(
        1.0d,
        table.doubleColumn(0).getDouble(0),
        APACHE_FIXED_LENGTH_DECIMAL + "[" + "l_partkey" + ",0] wrong value");
    assertEquals(
        24.0d,
  ...
  void testFixedLengthDecimalLegacy() throws IOException {
    ...
    assertEquals(
        table.column(0).type(),
        ColumnType.DOUBLE,
        APACHE_FIXED_LENGTH_DECIMAL_LEGACY + "[" + "l_partkey" + "] wrong type");
    assertEquals(
        1.0d,
        table.doubleColumn(0).getDouble(0),
        APACHE_FIXED_LENGTH_DECIMAL_LEGACY + "[" + "l_partkey" + ",0] wrong value");
    assertEquals(
        24.0d,
        table.doubleColumn(0).getDouble(23),
        APACHE_FIXED_LENGTH_DECIMAL_LEGACY + "[" + "l_partkey" + ",0] wrong value");
